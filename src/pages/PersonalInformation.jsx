...
export default function PersonalInformation() {
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-gray-50 dark:bg-gray-900 dark:text-white">
      <div className="flex h-full w-full max-w-none flex-col items-center justify-center">
        <div className="w-full max-w-xl rounded-lg bg-white p-6 shadow dark:border dark:border-gray-700 dark:bg-gray-800">
          {!started ? (
            ...
            <>
              ...
              {/* Puedes modificar el tamaño y color de fondo aquí */}
              <div className="mb-4 flex flex-wrap gap-2 font-semibold transition-all duration-300">
                {words.map((word, idx) => (
                  <span
                    ...
                    // Puedes cambiar text-3xl y bg-blue-600 aquí
                  >
                    {word}
                  </span>
                ))}
              ...
              <form onSubmit={handleSubmit} className="flex gap-1">
                ...
                <button
                  ...
                  disabled={isWaiting} // Deshabilita el botón mientras espera
                >
